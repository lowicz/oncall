...
export const primaryNav: NavItem[] = [
  // The team matrix lives on the dashboard itself (docs/PLAN.md §6 screen 1), so a
  // separate "Kalendarz" entry would point at the same view. /kalendarz stays routed
  ...
  // availability on behalf of someone who cannot (docs/PLAN-WYKONAWCZY-6.md tor D).
